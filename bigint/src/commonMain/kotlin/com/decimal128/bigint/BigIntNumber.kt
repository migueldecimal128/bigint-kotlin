...
sealed class BigIntNumber(
    ...
    // isProbablePrime() / nextProbablePrime() moved to com.decimal128.math
    // (bigint-math) as extension functions.
    ...
    // isqrt() / isPerfectSquare() moved to com.decimal128.math (bigint-math)
